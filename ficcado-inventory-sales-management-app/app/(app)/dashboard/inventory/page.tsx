...
export default function InventoryPage() {
  ...
  async function handleUpdateStock(e: React.FormEvent) {
    ...
    try {
      ...
      const data = await res.json();
      if (!res.ok) { setFormError(data.error || 'Failed to update stock'); return; }
        ...
        <div className="modal-backdrop" onClick={() => setShowModal(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 420 }}>
            <div className="modal-header">
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 18 }}>Update / Add Stock</h2>
            ...
            <form onSubmit={handleUpdateStock}>
              ...
              <div className="modal-footer">
                ...
                <button type="submit" className="btn btn-primary" disabled={submitting}>
                  {submitting ? <LoadingGecko size="inline" label="Saving…" /> : 'Update Stock'}
                </button>
              </div>
            </form>
          </div>
